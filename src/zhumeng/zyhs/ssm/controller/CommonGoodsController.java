...
public class CommonGoodsController {
	...
	public void getAll(HttpServletResponse response) throws IOException{
		...
		List<CommonGoods> visions = Service.getALL();
	...
	public void getByLevel(HttpServletResponse response,@RequestBody CommonGoods vo){
		List<CommonGoods> commongoods = Service.getByLevel(vo.getGoodsLevelId());
		JSONArray jsonArray;
		jsonArray = JSONArray.fromObject(commongoods);
		HttpReturn.reponseBody(response, jsonArray);
	}
	
	@RequestMapping(value="/get",method=RequestMethod.POST)
	public void get(HttpServletResponse response, @RequestBody CommonGoods vo) throws IOException{

		CommonGoods pojo = null;
	...
	public void add(HttpServletResponse response, @RequestBody CommonGoods vo) throws IOException{
	...
	public void update(HttpServletResponse response, @RequestBody CommonGoods vo) throws IOException{
