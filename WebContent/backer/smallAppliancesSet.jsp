...
.table-input {
	...
	background-color: transparent;
			...
			<h3>物品编辑--><a href="setGoodsMissing.action?level=${smallgoods.goodsLevelId}&bl=${smallgoods.id}">包含缺件</a></h3>
				<br>
				...
				<h3>物品编辑</h3>
				<hr />
				<form action="submitEditSmallAppliances.action" method="post">
					<table class="table table-striped ">
						<tr>
							<td>id：</td>
							<td><input name="id" id="id" type="text" value="${smallgoods.id}"
						...
						<tr>
							...
							<td><input name="goodsType" type="text"
								value="${smallgoods.goodsType }" class="table-input"
								style="font-size: 20px; color: #66AFE9;" /></td>
						</tr>
						<tr>
							<td>商品价格：</td>
							<td><input name="goodsPrice" type="text"
								value="${smallgoods.goodsPrice }" class="table-input" /></td>
						</tr>
						<tr>
							<td>商品是否完整:</td>
						...
						<tr>
							...
							<td><input name="introduce" type="text"
								value="${smallgoods.introduce }" class="table-input" /></td>
						</tr>
						 <tr>
                            <td>详情图片：</td>
                            <td>
                                <input type="button" value="详情图片1" class="tableButton" id="uploadButton1">
                                <img src="${smallgoods.imageUrl1}" alt="" name="flag1" class="tableImg"  width="200" height="130" >
                                <input type="text" name="imageUrl1" id="imgurl1" value="${smallgoods.imageUrl1}" hidden>
                                
                                <input type="button" value="详情图片2"  class="tableButton" id="uploadButton2">
                                <img src="${smallgoods.imageUrl2}" alt="" name="flag2" class="tableImg"  width="200" height="130">
                                <input type="text" name="imageUrl2" id="imgurl2" value="${smallgoods.imageUrl2}" hidden>
                                
                                <input type="button" value="详情图片3"  class="tableButton" id="uploadButton3">
                                <img src="${smallgoods.imageUrl3}" alt="" name="flag3"  class="tableImg"  width="200" height="130">
                                <input type="text" name="imageUrl3" id="imgurl3"  value="${smallgoods.imageUrl3}" hidden>
                            </td>
                    </tr>
					</table>
        ...
        if (imgTarget.attr('name') === 'flag1'){
            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    window.location.url = '/backer/samllAppliancesSet.jsp';
                }
            })
        }
    }
