	...
	width: 100px
		...
		<div class="questionCont">
			...
			<div class="cont-right">
			     <!-- <h3><a href="javascript:history.back(-1)">--返回></a></h3> -->
			    
				<div class="test-button">
				     <div class="test">
				          <a href="javascript:;" onClick="javascript:history.back(-1);">
			              <img src="static/icon/runback.png" name="返回" border="0" title="返回">返回</a>   
			        </div>
            ...
            <hr /> -->
				...
				<form action="deleteGoodsMissing.action" id="form" method="post">
					<table class="table table-striped ">
						...
						<c:forEach items="${mts}" var="goods">
							<tr>
								...
								<td><input
									onclick="window.location.href='editGoodsMissing.action?id=${goods.id}'"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="addGoodsMissing.action" method="post" id="addForm">
						<table class="table table-striped">
							<tr>
								<td>零件名称</td>
								<td><input name="toolsName" class="table-input"
									required="true" id="addGoodsType" /> <span style="color:red">(必填)</span>
                                    <input name="levelId" type="text" value="${mts[0].levelId}" hidden/>
                                    <input name="belongsId" type="text" value="${mts[0].belongsId}" hidden/>									
								</td>
							</tr>
							<tr>
								<td>商品价格：</td>
