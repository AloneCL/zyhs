	...
	width: 100px
		...
		<div class="questionCont">
            ...
            <hr /> -->
				...
				<form action="deleteCars.action" id="form" method="post">
					<table class="table table-striped ">
						...
						<c:forEach items="${cars}" var="goods">
							<tr>
								...
								<td><c:choose>
										<c:when test="${goods.carType==0}">摩托车/其他(元)</c:when>
										<c:when test="${goods.carType==1}">小汽车(元/t)</c:when>
								...
								<td><input type="button"
									...
									hidden></td>
								<td><input
									onclick="window.location.href='editCars.action?id=${goods.id}'"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="addCars.action" method="post" id="addForm">
						<table class="table table-striped">
							<tr>
								<td>商品名称</td>
								<td><input name="goodsType" class="table-input"
									required="true" id="addGoodsType" /> <input type="button" value="设置封面"
									class="tableButton" id="uploadButton"> <img src=""
									alt="" class="tableImg" width="200" height="130"> <input
									type="text" name="imageUrl1" id="imgurl" hidden><span style="color:red">(必填)</span></td>
							</tr>
							<tr>
								<td>商品价格：</td>
							...
							<tr>
								...
								<td><select name="carType">
										<option value="0">摩托车/其他(元)</option>
										<option value="1">小汽车(元/t)</option>
								</select></td>
							</tr>
						</table>
					</form>
