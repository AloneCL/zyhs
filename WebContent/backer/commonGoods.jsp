	...
	width: 100px
		...
		<div class="questionCont">
            ...
            <hr /> -->
				...
				<form action="deleteGoods.action" id="form" method="post">
					<table class="table table-striped ">
						...
						<c:forEach items="${goods}" var="goods">
							<tr>
								...
								<td><c:choose>
										<c:when test="${goods.payType==0}">积分制(积分/个)</c:when>
										<c:when test="${goods.payType==1}">单价制(元/Kg)</c:when>
								...
								<td><input type="button"
									...
									height="130" name="flag" /> 
									<input type="text" name="imgurl" hidden></td>
								<td><input
									onclick="window.location.href='editCommonGoods.action?id=${goods.id}'"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="addGoods.action" method="post" id="addForm">
						<table class="table table-striped">
							<tr>
								<td>商品名称</td>
								<td><input name="goodsType" class="table-input"
									required="required" id="addGoodsType"/> <input type="button" value="设置封面"
							...
							<tr>
								...
								<td><select name="payType">
										<option value="0">根据积分</option>
										<option value="1">根据单价</option>
								</select></td>
							</tr>
						</table>
					</form>
