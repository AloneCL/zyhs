...
#add>div>div>div.modal-body>form>table>tbody>tr>td:nth-child(1) {
	width: 100px
		...
		<div class="questionCont">
			...
			<script>
			$("#nav-il-2").children('li:nth-child(3)').addClass("visiting");
            ...
            <hr /> -->
				...
				<form action="deleteRefrigerator.action" id="form" method="post">
					<table class="table table-striped ">
						...
						<c:forEach items="${rgs}" var="goods">
							<tr>
								...
								<td><c:choose>
										<c:when test="${goods.capacity==0}">90-120L</c:when>
										<c:when test="${goods.capacity==1}">121-150L</c:when>
										<c:when test="${goods.capacity==2}">151-220L</c:when>
										<c:when test="${goods.capacity==3}">221-500L</c:when>
								...
								<td><input type="button"
									...
									hidden></td>
								<td><input
									onclick="window.location.href='editRefrigerator.action?id=${goods.id}'"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="addRefrigerator.action" method="post" id="addForm">
						<table class="table table-striped">
							<tr>
								<td>商品名称</td>
							...
							<tr>
								...
								<td><select name="capacity">
										<option value="0">90-120L</option>
										<option value="1">121-150L</option>
										<option value="2">151-220L</option>
										<option value="3">221-500L</option>
								</select></td>
							</tr>
						</table>
					</form>
